...
def test_discrete_divs():
    ...
    actual = decimal_round(
        discrete_divs(1, 100, 100, 0.06, 0.3, datetime(2023, 1, 1), datetime(2023, 12, 31), 100, [(datetime(2023, 7, 2), 7)]))
    ...
    actual = decimal_round(
        discrete_divs(1, 100, 130, 0.06, 0.3, datetime(2023, 1, 1), datetime(2023, 12, 31), 100, [(datetime(2023, 7, 2), 7)]))
    ...
    actual = decimal_round(
        discrete_divs(1, 100, 70, 0.06, 0.3, datetime(2023, 1, 1), datetime(2023, 12, 31), 100, [(datetime(2023, 7, 2), 7)]))
    ...
    actual = decimal_round(
        discrete_divs(1, 100, 100, 0.06, 0.3, datetime(2023, 1, 1), datetime(2023, 12, 31), 100, [(datetime(2023, 7, 2), 30)]))
    ...
    actual = decimal_round(
        discrete_divs(1, 100, 130, 0.06, 0.3, datetime(2023, 1, 1), datetime(2023, 12, 31), 100, [(datetime(2023, 7, 2), 30)]))
    ...
    actual = decimal_round(
        discrete_divs(1, 100, 70, 0.06, 0.3, datetime(2023, 1, 1), datetime(2023, 12, 31), 100, [(datetime(2023, 7, 2), 30)]))
    ...
    actual = decimal_round(
        discrete_divs(1, 100, 100, 0.06, 0.3, datetime(2023, 1, 1), datetime(2023, 12, 31), 100, [(datetime(2023, 7, 2), 50)]))
    ...
    actual = decimal_round(
        discrete_divs(1, 100, 130, 0.06, 0.3, datetime(2023, 1, 1), datetime(2023, 12, 31), 100, [(datetime(2023, 7, 2), 50)]))
    ...
    actual = decimal_round(
        discrete_divs(1, 100, 70, 0.06, 0.3, datetime(2023, 1, 1), datetime(2023, 12, 31), 100, [(datetime(2023, 7, 2), 50)]))
    expected = 32.3034  # Expected option price
    print("Expected:", expected, "Actual:", actual)
    assert abs((actual - expected) / expected) < TOLERANCE


    # THESE ARE EXAMPLES THAT DEAN & LUKE CAME UP WITH

    actual = decimal_round(
        discrete_divs(1, 100, 100, 0.053, 0.3, datetime(2023, 11, 9), datetime(2024, 11, 9), 100, [(datetime(2024, 6, 15), 10)]))
    expected = 11.5347  # Expected option price
    print("Expected:", expected, "Actual:", actual)
    assert abs((actual - expected) / expected) < TOLERANCE


    actual = decimal_round(
        discrete_divs(1, 100, 100, 0.053, 0.3, datetime(2023, 11, 9), datetime(2024, 11, 9), 100, [(datetime(2023, 12, 15), 5), (datetime(2024, 6, 15), 3)]))
    expected = 10.0671  # Expected option price
    print("Expected:", expected, "Actual:", actual)
    assert abs((actual - expected) / expected) < TOLERANCE


    actual = decimal_round(
        discrete_divs(1, 100, 120, 0.053, 0.3, datetime(2023, 11, 9), datetime(2024, 11, 9), 100, [(datetime(2023, 12, 15), 5), (datetime(2024, 6, 15), 3)]))
    expected = 4.3950  # Expected option price
    print("Expected:", expected, "Actual:", actual)
    assert abs((actual - expected) / expected) < TOLERANCE


    actual = decimal_round(
        discrete_divs(1, 100, 100, 0.023, 0.4, datetime(2023, 11, 9), datetime(2024, 11, 9), 100, [(datetime(2023, 12, 15), 5), (datetime(2024, 6, 15), 3), (datetime(2024, 10, 21), 2)]))
    expected = 12.57  # Expected option price
    print("Expected:", expected, "Actual:", actual)
    assert abs((actual - expected) / expected) < TOLERANCE
    ...
    actual = decimal_round(
        discrete_divs(-1, 100, 100, 0.053, 0.3, datetime(2023, 11, 9), datetime(2024, 11, 9), 100, [(datetime(2023, 12, 15), 5), (datetime(2024, 6, 15), 3)]))
    expected = 13.2202  # Expected option price
    print("Expected:", expected, "Actual:", actual)
    assert abs((actual - expected) / expected) < TOLERANCE
